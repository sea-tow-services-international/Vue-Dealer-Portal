      ...
      return (
        ...
        ((this.price_total > 0 ||
          ...
          (this.funds_collected_locally == "false" ||
            this.funds_collected_locally == false)) ||
        ((this.autorenew_status == "true" || this.autorenew_status == true) &&
            ...
            .then(() => {
              ...
              if (this.cc_declined == false) {
                ...
                if (this.isRenew) {
                  ...
                  data["accountid"] = this.account_sfid;
                  data["membership__c"] = this.membership_sfid;
                  ...
                  axios({
                    ...
                    data["contactid"] = this.contact_sfid;
                    ...
                    axios({
                      ...
                      console.log("contactroles response: " + response);
                          ...
                          if (
                            ...
                            axios({
                              ...
                              axios({
                                ...
                                console.log(response);
                                console.log(
                                  "renewal payments insertion result"
                                );
                              });
                            });
                          } else if (
